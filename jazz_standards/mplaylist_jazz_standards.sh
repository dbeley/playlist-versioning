...
[[ -f "$JAZZ_STANDARDS_FILE" ]] || { echo "Error: jazz_standards.txt file not found."; exit 1; }
[[ -f "$JAZZ_ARTISTS_ALLOWLIST_FILE" ]] || { echo "Error: jazz_artists_allowlist.txt file not found."; exit 1; }
